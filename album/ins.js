      ...
      var render = function render(res) {
        ...
        for (var j = 0, len2 = res.list.length; j < len2; j++) {
          ...
          for (var i = 0, len = data.link.length; i < len; i++) {
            ...
            var minSrc = 'https://raw.githubusercontent.com/xinglinbaobao/xinglinbaobao.github.io/master/album/min_photos/' + data.link[i];
  
            var src = 'https://raw.githubusercontent.com/xinglinbaobao/xinglinbaobao.github.io/master/album/photos/' + data.link[i];
          ...
          ulTmpl = ulTmpl 
           ...
           + '<h1 class="year">' + data.year + '年<em>' + data.month + '月</em></h1>'
